...
n:-player(X,Y,S,Lp,H,T,W,[L]),Y\==1,Y1 is Y - 1,retract(player(X,Y,S,Lp,H,T,W,[L])),asserta(player(X,Y1,S,Lp,H,T,W,[L])).
e:-player(X,Y,S,Lp,H,T,W,[L]),X\==20,X1 is X + 1,retract(player(X,Y,S,Lp,H,T,W,[L])),asserta(player(X1,Y,S,Lp,H,T,W,[L])).
s:-player(X,Y,S,Lp,H,T,W,[L]),Y\==10,Y1 is Y + 1,retract(player(X,Y,S,Lp,H,T,W,[L])),asserta(player(X,Y1,S,Lp,H,T,W,[L])).
w:-player(X,Y,S,Lp,H,T,W,[L]),X\==1,X1 is X - 1,retract(player(X,Y,S,Lp,H,T,W,[L])),asserta(player(X1,Y,S,Lp,H,T,W,[L])).
