...
attack :- player(X,Y,S,Lp,H,T,W,L), W =:= 1, e1(X,Y,'alive',Atk1,O), retract(e1(X,Y,'alive',Atk1,O)), 
		...
		F is Lp-Atk1, \+ isDead(F), asserta(player(X,Y,S,F,H,T,W,L)), write('you\'ve been wounded -'),write(Atk1), write(' HP\nk.'), retract(itemE1(-1,-1,'taken',0)),asserta(itemE1(X,Y,'available',O)),write('Your enemy drop '),write(O),moveenemy,write('\n').
attack :- player(X,Y,S,Lp,H,T,W,L), W =:= 1, e2(X,Y,'alive',Atk1,O), retract(e2(X,Y,'alive',Atk1,O)), 
		...
		F is Lp-Atk1, \+ isDead(F), asserta(player(X,Y,S,F,H,T,W,L)), write('you\'ve been wounded -'),write(Atk1), write(' HP\n'), retract(itemE2(-1,-1,'taken',0)),asserta(itemE2(X,Y,'available',O)),write('Your enemy drop '),write(O),moveenemy,write('\n').
attack :- player(X,Y,S,Lp,H,T,W,L), W =:= 1, e3(X,Y,'alive',Atk1,O), retract(e3(X,Y,'alive',Atk1,O)), 
		...
		F is Lp-Atk1, \+ isDead(F), asserta(player(X,Y,S,F,H,T,W,L)), write('you\'ve been wounded -'),write(Atk1), write(' HP\n'), retract(itemE3(-1,-1,'taken',0)),asserta(itemE3(X,Y,'available',O)),write('Your enemy drop '),write(O),moveenemy,write('\n').
attack :- player(X,Y,S,Lp,H,T,W,L), W =:= 1, e4(X,Y,'alive',Atk1,O), retract(e4(X,Y,'alive',Atk1,O)), 
		...
		F is Lp-Atk1, \+ isDead(F), asserta(player(X,Y,S,F,H,T,W,L)), write('you\'ve been wounded -'),write(Atk1), write(' HP\n'), retract(itemE4(-1,-1,'taken',0)),asserta(itemE4(X,Y,'available',O)),write('Your enemy drop '),write(O),moveenemy,write('\n').
attack :- player(X,Y,S,Lp,H,T,W,L), W =:= 1, e5(X,Y,'alive',Atk1,O), retract(e5(X,Y,'alive',Atk1,O)), 
		...
		F is Lp-Atk1, \+ isDead(F), asserta(player(X,Y,S,F,H,T,W,L)), write('you\'ve been wounded -'),write(Atk1), write(' HP\n'), retract(itemE5(-1,-1,'taken',0)),asserta(itemE5(X,Y,'available',O)),write('Your enemy drop '),write(O),moveenemy,write('\n').
attack :- player(X,Y,S,Lp,H,T,W,L), W =:= 1, e6(X,Y,'alive',Atk1,O), retract(e6(X,Y,'alive',Atk1,O)), 
		...
		F is Lp-Atk1, \+ isDead(F), asserta(player(X,Y,S,F,H,T,W,L)), write('you\'ve been wounded -'),write(Atk1), write(' HP\n'), retract(itemE6(-1,-1,'taken',0)),asserta(itemE6(X,Y,'available',O)),write('Your enemy drop '),write(O),moveenemy,write('\n').
attack :- player(X,Y,S,Lp,H,T,W,L), W =:= 1, e7(X,Y,'alive',Atk1,O), retract(e7(X,Y,'alive',Atk1,O)), 
		...
		F is Lp-Atk1, \+ isDead(F), asserta(player(X,Y,S,F,H,T,W,L)), write('you\'ve been wounded -'),write(Atk1), write(' HP\n'), retract(itemE7(-1,-1,'taken',0)),asserta(itemE7(X,Y,'available',O)),write('Your enemy drop '),write(O),moveenemy,write('\n').
attack :- player(X,Y,S,Lp,H,T,W,L), W =:= 1, e8(X,Y,'alive',Atk1,O), retract(e8(X,Y,'alive',Atk1,O)), 
		...
		F is Lp-Atk1, \+ isDead(F), asserta(player(X,Y,S,F,H,T,W,L)), write('you\'ve been wounded -'),write(Atk1), write(' HP\n'), retract(itemE8(-1,-1,'taken',0)),asserta(itemE8(X,Y,'available',O)),write('Your enemy drop '),write(O),moveenemy,write('\n').
attack :- player(X,Y,S,Lp,H,T,W,L), W =:= 1, e9(X,Y,'alive',Atk1,O), retract(e9(X,Y,'alive',Atk1,O)), 
		...
		F is Lp-Atk1, \+ isDead(F), asserta(player(X,Y,S,F,H,T,W,L)), write('you\'ve been wounded -'),write(Atk1), write(' HP\n'), retract(itemE9(-1,-1,'taken',0)),asserta(itemE9(X,Y,'available',O)),write('Your enemy drop '),write(O),moveenemy,write('\n').
attack :- player(X,Y,S,Lp,H,T,W,L), W =:= 1, e10(X,Y,'alive',Atk1,O), retract(e10(X,Y,'alive',Atk1,O)), 
		...
		F is Lp-Atk1, \+ isDead(F), asserta(player(X,Y,S,F,H,T,W,L)), write('you\'ve been wounded -'),write(Atk1), write(' HP\n'), retract(itemE10(-1,-1,'taken',0)),asserta(itemE10(X,Y,'available',O)),write('Your enemy drop '),write(O),moveenemy,write('\n').
