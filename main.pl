setup :- consult(enemy),consult(map),consult(player),consult(save),consult(item),consult(terrain),consult('Attack.pl'),consult(commands),initPlayer,initTerrain,initItem,initMap,initEnemy.
