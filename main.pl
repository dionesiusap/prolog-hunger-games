setup :- consult(enemy),consult(map),consult(save),consult(player),consult(item),consult(terrain),consult('Attack.pl'),consult(commands),initPlayer,initTerrain,initItem,initMap,initEnemy.
